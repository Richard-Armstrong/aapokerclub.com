...
<head>
	<meta charset="utf-8">
	<title>Sign in &middot; <?= WEBSITE_TITLE ?></title>
...
<body>
	<div class="container">
		...
		<div style="text-align:center;"><img src="<?= base_url("img/AAPC.gif") ?>" style="background:linear-gradient(135deg, #8f75da 0%, #727cf5 60%);"/></div>

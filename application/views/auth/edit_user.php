	...
	<div class="container-fluid">
		...
		<div class="card">
			<div class="card-body">
				...
				<?php if (is_superuser($this->session->userdata('user')->level)) : ?>
					<div class="form-group">
				...
				<?php if (is_account_manager($this->session->userdata('user')->level)) : ?>
					<div class="form-group">
				...
				<?php if (is_superuser($this->session->userdata('user')->level) || $this->ion_auth->user()->id == $user->id) : ?>
					<div class="form-group">
				...
				<?php if (is_company_manager($this->session->userdata('user')->level)) : ?>
					<?php if (compare_user_level($this->session->userdata('user')->level, $user->level)) : ?>
						<div class="form-group">
							<h4>User Level</h4>
